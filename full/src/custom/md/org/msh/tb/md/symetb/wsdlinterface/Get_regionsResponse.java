...
public class Get_regionsResponse  implements java.io.Serializable {
    private Get_regionsResponseGet_regionsResult get_regionsResult;

    public Get_regionsResponse() {
    }

    public Get_regionsResponse(
           Get_regionsResponseGet_regionsResult get_regionsResult) {
     ...
     */
    public Get_regionsResponseGet_regionsResult getGet_regionsResult() {
        return get_regionsResult;
    }
     ...
     */
    public void setGet_regionsResult(Get_regionsResponseGet_regionsResult get_regionsResult) {
        this.get_regionsResult = get_regionsResult;
    }
