...
public class Get_users_additional_unitsResponse  implements java.io.Serializable {
    private Get_users_additional_unitsResponseGet_users_additional_unitsResult get_users_additional_unitsResult;

    public Get_users_additional_unitsResponse() {
    }

    public Get_users_additional_unitsResponse(
           Get_users_additional_unitsResponseGet_users_additional_unitsResult get_users_additional_unitsResult) {
     ...
     */
    public Get_users_additional_unitsResponseGet_users_additional_unitsResult getGet_users_additional_unitsResult() {
        return get_users_additional_unitsResult;
    }
     ...
     */
    public void setGet_users_additional_unitsResult(Get_users_additional_unitsResponseGet_users_additional_unitsResult get_users_additional_unitsResult) {
        this.get_users_additional_unitsResult = get_users_additional_unitsResult;
    }
