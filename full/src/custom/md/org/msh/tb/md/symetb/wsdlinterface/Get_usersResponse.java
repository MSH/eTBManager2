...
public class Get_usersResponse  implements java.io.Serializable {
    private Get_usersResponseGet_usersResult get_usersResult;

    public Get_usersResponse() {
    }

    public Get_usersResponse(
           Get_usersResponseGet_usersResult get_usersResult) {
     ...
     */
    public Get_usersResponseGet_usersResult getGet_usersResult() {
        return get_usersResult;
    }
     ...
     */
    public void setGet_usersResult(Get_usersResponseGet_usersResult get_usersResult) {
        this.get_usersResult = get_usersResult;
    }
