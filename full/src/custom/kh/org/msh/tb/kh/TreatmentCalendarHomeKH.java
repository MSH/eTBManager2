 ...
 *
 */
@Name("treatmentCalendarHomeKH")
public class TreatmentCalendarHomeKH extends TreatmentCalendarHome{
	...
	protected void mountDispensing() {
		List<TreatmentMonitoringKH> lst = entityManager.createQuery("from TreatmentMonitoringKH c  " +
				"where c.tbcase.id = :id ")
				.setParameter("id", super.caseHome.getId())
				.getResultList();

		for (TreatmentMonitoringKH tm: lst) {
