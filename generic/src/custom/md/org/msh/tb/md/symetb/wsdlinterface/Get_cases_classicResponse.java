...
public class Get_cases_classicResponse  implements java.io.Serializable {
    private Get_cases_classicResponseGet_cases_classicResult get_cases_classicResult;

    public Get_cases_classicResponse() {
    }

    public Get_cases_classicResponse(
           Get_cases_classicResponseGet_cases_classicResult get_cases_classicResult) {
     ...
     */
    public Get_cases_classicResponseGet_cases_classicResult getGet_cases_classicResult() {
        return get_cases_classicResult;
    }
     ...
     */
    public void setGet_cases_classicResult(Get_cases_classicResponseGet_cases_classicResult get_cases_classicResult) {
        this.get_cases_classicResult = get_cases_classicResult;
    }
