...
public class Get_casesResponse  implements java.io.Serializable {
    private Get_casesResponseGet_casesResult get_casesResult;

    public Get_casesResponse() {
    }

    public Get_casesResponse(
           Get_casesResponseGet_casesResult get_casesResult) {
     ...
     */
    public Get_casesResponseGet_casesResult getGet_casesResult() {
        return get_casesResult;
    }
     ...
     */
    public void setGet_casesResult(Get_casesResponseGet_casesResult get_casesResult) {
        this.get_casesResult = get_casesResult;
    }
