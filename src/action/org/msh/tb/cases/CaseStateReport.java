...
*/
	...
	protected void createTagsReport() {
		...
		List<Object[]> lst = entityManager.createNativeQuery("select t.id, t.tag_name, t.sqlCondition is null, count(*) " +
		...
		for (Object[] vals: lst) {
			...
			item.setAutoGenerated((Integer)vals[2] == 0);
			item.setCases(((BigInteger)vals[3]).intValue());
			tags.add(item);
		}
	}
