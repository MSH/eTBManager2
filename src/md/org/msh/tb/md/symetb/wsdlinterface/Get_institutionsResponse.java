...
public class Get_institutionsResponse  implements java.io.Serializable {
    private Get_institutionsResponseGet_institutionsResult get_institutionsResult;

    public Get_institutionsResponse() {
    }

    public Get_institutionsResponse(
           Get_institutionsResponseGet_institutionsResult get_institutionsResult) {
     ...
     */
    public Get_institutionsResponseGet_institutionsResult getGet_institutionsResult() {
        return get_institutionsResult;
    }
     ...
     */
    public void setGet_institutionsResult(Get_institutionsResponseGet_institutionsResult get_institutionsResult) {
        this.get_institutionsResult = get_institutionsResult;
    }
