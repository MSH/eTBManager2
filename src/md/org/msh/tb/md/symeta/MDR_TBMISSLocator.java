...
public class MDR_TBMISSLocator extends org.apache.axis.client.Service implements org.msh.tb.md.symeta.MDR_TBMISS {
    ...
    public org.msh.tb.md.symeta.MDR_TBMISSSoap getMDR_TBMISSSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public org.msh.tb.md.symeta.MDR_TBMISSSoap getMDR_TBMISSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.msh.tb.md.symeta.MDR_TBMISSSoap12Stub _stub = new org.msh.tb.md.symeta.MDR_TBMISSSoap12Stub(portAddress, this);
    ...
    public org.msh.tb.md.symeta.MDR_TBMISSSoap getMDR_TBMISSSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public org.msh.tb.md.symeta.MDR_TBMISSSoap getMDR_TBMISSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.msh.tb.md.symeta.MDR_TBMISSSoapStub _stub = new org.msh.tb.md.symeta.MDR_TBMISSSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.msh.tb.md.symeta.MDR_TBMISSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.msh.tb.md.symeta.MDR_TBMISSSoap12Stub _stub = new org.msh.tb.md.symeta.MDR_TBMISSSoap12Stub(new java.net.URL(MDR_TBMISSSoap12_address), this);
                _stub.setPortName(getMDR_TBMISSSoap12WSDDServiceName());
                return _stub;
            }
            if (org.msh.tb.md.symeta.MDR_TBMISSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.msh.tb.md.symeta.MDR_TBMISSSoapStub _stub = new org.msh.tb.md.symeta.MDR_TBMISSSoapStub(new java.net.URL(MDR_TBMISSSoap_address), this);
                _stub.setPortName(getMDR_TBMISSSoapWSDDServiceName());
                return _stub;
            }
        }
