...
public class CaseCloseHome extends Controller{
	...
	private static final CaseState[] outcomesMDR = {
		...
		CaseState.DIAGNOSTIC_CHANGED_TO_NOT_DRTB,
		CaseState.DIAGNOSTIC_CHANGED_TO_MDR,
		CaseState.DIAGNOSTIC_CHANGED_TO_MONO,
		CaseState.DIAGNOSTIC_CHANGED_TO_POLY,
		CaseState.DIAGNOSTIC_CHANGED_TO_XDR,
		CaseState.OTHER};
