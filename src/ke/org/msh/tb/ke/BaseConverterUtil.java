...
public class BaseConverterUtil {
	...
	private static final String baseDigits35 = "0123456789ABCDEFGHIJKLMNPQRSTUVWXYZ";  
    ...
    public static String toBase35( int decimalNumber ) {  
        ...
        while( decimalNumber != 0 ) {  
            ...
            tempVal = baseDigits35.substring( mod, mod + 1 ) + tempVal;  
    ...
    public static int fromBase35( String base35Number ) {
        int iterator = base35Number.length();  
        int returnValue = 0;  
        int multiplier = 1;  
        int base = 35;
  
        while( iterator > 0 ) {  
            returnValue = returnValue + ( baseDigits35.indexOf( base35Number.substring( iterator - 1, iterator ) ) * multiplier );  
    ...
    public static void main (String [] args){
    	System.out.println("Inside Base Converter == "+toBase62(99999));
    	System.out.println("back to base == "+fromBase62(toBase62(99999)));

    	System.out.println("Inside Base Converter == "+toBase35(24));
    	System.out.println("back to base == "+fromBase35(toBase35(24)));
