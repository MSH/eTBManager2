 ...
 *
 */
@Name("registerDispensingHome_Ke")
...
public class RegisterDispensingHome {
	...
	private List<org.msh.tb.ke.WeekInfo> weeks;
	...
	public String save() {
		...
		for (CaseDispensingInfo dispInfo: cases) {
			...
			CaseDispensing_Ke caseDisp = dispInfo.getCaseDispensing();
	...
	protected void createCasesList() {
		...
		for (CaseDispensing_Ke disp: lst) {
	...
	public org.msh.tb.ke.WeekInfo getSelectedWeek() {
		if (weeks == null)
			createCasesList();
		if (weeks != null) {
