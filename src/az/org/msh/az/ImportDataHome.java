...
import org.msh.tb.importexport.ImportAsyncExecution;
...
public class ImportDataHome {
	...
	public String execute() {
		...
		try {
			importAsyncExecution.execute("az.caseImport", file, charset, delimiter, defaultWorkspace, (UserLogin)Component.getInstance("userLogin", true));
